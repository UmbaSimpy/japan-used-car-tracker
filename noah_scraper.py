...
# Tuned from an initial full scrape: this current-gen Noah Hybrid S-Z 2WD is
# still selling near-new (most listings have <10,000km), with observed prices
# ranging ¥330万–¥494万, avg ¥402万. Re-tune if the market shifts over time.
GRADE_PRICE_ANCHORS: dict[str, tuple[float, float, float]] = {
    # (floor_man, ceiling_man, typical_man)
    "hybrid_sz": (320.0, 500.0, 400.0),
}
_DEFAULT_ANCHORS: tuple[float, float, float] = (320.0, 500.0, 400.0)
