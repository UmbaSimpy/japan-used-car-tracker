...
# bargain), and those stripped units typically lack nav/camera. Rewarding
# equipment and easing the near-zero-km bonus surfaces genuinely good value.
WEIGHTS = {
    "price":       0.34,   # relative within grade — cheapest = 10, falls off steeply
    "mileage":     0.12,   # ↓ — ease the near-0 km over-reward
    "shaken":      0.04,   # short shaken still viable, buyer can renew
    "accident":    0.13,
    "warranty":    0.08,
    "maintenance": 0.03,
...
# the cheapest car in a grade scores 10 and the score falls off steeply. Each grade is
# scored against its own price distribution, so grades are never penalised against each other.
